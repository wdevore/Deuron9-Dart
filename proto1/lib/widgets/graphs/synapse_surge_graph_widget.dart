...
class SynapseSurgeGraphWidget extends StatefulWidget {
  final double height;
  final Color bgColor;
  final AppState appState;
  final SampleData sampleData;

  const SynapseSurgeGraphWidget(
    this.appState, {
    super.key,
  ...
  @override
  State<SynapseSurgeGraphWidget> createState() =>
      _SynapseSurgeGraphWidgetState();
}

class _SynapseSurgeGraphWidgetState extends State<SynapseSurgeGraphWidget> {
  @override
