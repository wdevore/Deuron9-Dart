...
class SomaAPSlowGraphWidget extends StatefulWidget {
  final double height;
  final Color bgColor;
  final AppState appState;
  final SampleData sampleData;

  const SomaAPSlowGraphWidget(
    this.appState, {
    super.key,
  ...
  @override
  State<SomaAPSlowGraphWidget> createState() => _SomaAPSlowGraphWidgetState();
}

class _SomaAPSlowGraphWidgetState extends State<SomaAPSlowGraphWidget> {
  @override
  ...
  void _draw(Canvas canvas, Size size, double strokeWidth, AppState appState) {
    ...
    for (var t = cm.rangeStart; t < cm.rangeEnd; t++) {
      ...
      double uY = Maths.mapSampleToUnit(
        sY,
        samples.samples.somaAPSlowMin,
        samples.samples.somaAPSlowMax,
      );
